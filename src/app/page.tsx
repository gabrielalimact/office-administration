  ...
  return (
    <Flex
      style={{
        ...
        color: 'white',
        background:
          'linear-gradient(209deg,rgba(36, 34, 112, 1) 0%, rgba(51, 51, 143, 1) 54%, rgba(207, 249, 255, 1) 100%)',
      }}
    >
      <Box width={{ base: '100%', md: '55%' }} paddingLeft={{ base: 0, md: 10 }}>
        ...
        >
          <Image src="/images/balanca.svg" alt="Logo" width={50} height={50} />
          <Text fontSize="xl" fontWeight="bold">
            Diego Oliveira Nascimento
          </Text>
          <Text fontSize="lg">Advocacia & Consultoria</Text>
        </Flex>
        ...
        >
          ...
          <Text>Este é um sistema de administração para gerenciar processos jurídicos.</Text>
      ...
      >
        <Image src="/images/advogado.avif" alt="Banner Login/Register page" />
      </Flex>
    </Flex>
  );
}
